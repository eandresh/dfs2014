...
["", "jacruzca_dart_angular.dart", , X, {
  "": "",
  main: [function() {
    $.masa = document.querySelector("#masa");
    $.estatura = document.querySelector("#estatura");
    $.resultado = document.querySelector("#resultado");
    $.calculateButton = document.querySelector("#calculate");
    P.print("Buuuuuuuuu");
    var t1 = $.calculateButton;
    t1.toString;
    t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t1, C.EventStreamProvider_click._eventType, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(X.calculate$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  }, "call$0", "main$closure", 0, 0, 1],
  calculate: [function(e) {
    var masaVal, estaturaVal, t1;
    masaVal = H.Primitives_parseDouble(J.get$value$x($.masa), null);
    estaturaVal = H.Primitives_parseDouble(J.get$value$x($.estatura), null);
    t1 = J.$mul$n(estaturaVal, estaturaVal);
    if (typeof masaVal !== "number")
      return masaVal.$div();
    if (typeof t1 !== "number")
      return H.iae(t1);
    J.set$value$x($.resultado, C.JSNumber_methods.toString$0(masaVal / t1));
  }, "call$1", "calculate$closure", 2, 0, 9]
},
1],
]);
